...
### Created by ©DYNA-MIKA.be , all rights reserved. Credits much appreciated. 
### #This script works well with Jamf Pro and Kandji

## VARIABLES

#Specify which local admin should have ARD enabled
LOCALADMIN=""
#Path to kickstart
